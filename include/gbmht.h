...
extern "C"
{
void gbm_ht_24_2x2(const GBM *gbm, const byte *data24, byte *data24a, byte rm, byte gm, byte bm);

void gbm_ht_pal_6R6G6B(GBMRGB *gbmrgb);
void gbm_ht_6R6G6B_2x2(const GBM *gbm, const byte *data24, byte *data8);

void gbm_ht_pal_7R8G4B(GBMRGB *gbmrgb);
void gbm_ht_7R8G4B_2x2(const GBM *gbm, const byte *data24, byte *data8);
